...
export default function Card({ projectCard }) {
  return (
    <>
      <div className="w-42 md:w-52 lg:w-80 flex flex-col gap-2 cursor-pointer  bg-white pt-2 px-2 rounded-lg hover:scale-105 ">
        ...
        <div className=" lg:flex justify-between items-center p-2 ">
         ...
         <Link to={`/projects/${projectCard.id}`}> <Button
        colorScheme="blue"
